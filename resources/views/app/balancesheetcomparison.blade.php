...
<div class="row">
    <div class="col-md-12">
        <h4>Balance Sheet Comparison Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Balance Sheet Comparison";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Balance Sheet Comparison</td>
                    </tr>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:14px;">Assets</td>
                    </tr>
                    <tr>
                        <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:11px;">Current Assets</td>
                    </tr>
                    <?php
                    $IncomeTotal=0;
                    ?>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="5" style="border-bottom:1px dotted #ccc"></td>
                    </tr>
                    <?php
                    $IncomeTotal=0;
                    ?>
                    ...
                    <tr>
                        <td colspan="5" style="border-bottom:2px dotted #ccc"></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:11px;"></td>
                    </tr>
                    <?php
                    $IncomeTotal=0;
                    $TotalFixedAsset=0;
                    ...
                    <tr>
                        <td colspan="5" style="border-bottom:3px dotted #ccc"></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:14px;">Liabilities</td>
                        ...
                        <tr>
                            <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:14px;">Equity</td>
                        </tr>
                        <tr>
                            <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                            <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
