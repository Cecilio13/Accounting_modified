                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'salesbyProduct_Summary_by_date',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Sales By Product/Services Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Sales By Product/Services";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Sales By Product/Services</td>
                    </tr>
                    <tr>
                        ...
                        var idcount=[];
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tr style="border-bottom:1px solid #ccc;">
                                    ...
                                    <td style="text-align:right;vertical-align:middle" id="QTY{{$st_i}}">
                                    <script>
                                        $(document).ready(function(){
                                        var qty=0;
                                        var amount='';
                                        ...
                                        @foreach($input as $STI)
                                            ...
                                            if('{{$STI["st_i_product"]}}'=='{{$st_i}}'){
                                                ...
                                                document.getElementById('AVG{{$st_i}}').innerHTML=(AVG).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                                                document.getElementById('Amount{{$st_i}}').innerHTML=(amount).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                                                document.getElementById('QTY{{$st_i}}').innerHTML=qty;
                                            }
                                        @endforeach
                                    ...
                                    <td style="text-align:right;vertical-align:middle" id="Amount{{$st_i}}">
                                        
                                    </td>
                                    <td style="text-align:right;vertical-align:middle" id="Percent{{$st_i}}">

                                    </td>
                                    <td style="text-align:right;vertical-align:middle" id="AVG{{$st_i}}">
                                ...
                                <script>
                                    $(document).ready(function(){
                                            ...
                                            if('{{$STI["st_i_product"]}}'=='{{$st_i}}'){
                                                    ...
                                                    amount=amount*qty;
                                                    AVG=AVG*1;
                                                    percenteage=(amount*100)/totalall;
                                                    document.getElementById('Percent'+idcount[idex]).innerHTML=(percenteage).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')+" %";
                                                    idex++;
                                                }
                                            @endforeach
                                            @endforeach
