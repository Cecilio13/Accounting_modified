                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'AR_REceivable_ageing_by_date',                
...
<div class="row">
    <div class="col-md-12">
        <h4>A/R Receivable Ageing Summary Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="A/R Receivable Ageing Summary";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >A/R Receivable Ageing Summary</td>
                    </tr>
                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align:middle;">
                                            ...
                                            @foreach ($customers as $customer)
                                                ...
                                                {{$customer->display_name!=""? $customer->display_name  : $customer->f_name." ".$customer->l_name }}   
                                                @endif
                                            @endforeach
                                            {{-- {{$ST->st_no}}<br>
                                            {{$ST->display_name!=""? $ST->display_name  : $ST->f_name." ".$ST->l_name }} --}}
                                        </td>
                                        <td style="vertical-align:middle;" id="invoicetotaltd{{$ST->st_payment_for}}">
                                               <?php
                                                $total=0;
                                               ?>
                                        ...
                                        <td style="vertical-align:middle;" id="one{{$ST->st_payment_for}}">
                                            ...
                                            @endif
                                            @endforeach
                                            {{number_format($totalone,2)}}
                                        </td>
                                        <td style="vertical-align:middle;" id="two{{$ST->st_payment_for}}">
                                            {{number_format($totalrqo,2)}}
                                        </td>
                                        <td style="vertical-align:middle;" id="three{{$ST->st_payment_for}}">
                                            {{number_format($totalthree,2)}}
                                        </td>
                                        <td style="vertical-align:middle;" id="four{{$ST->st_payment_for}}">
                                            {{number_format($totalfour,2)}}
                                        </td>
                                        <td style="vertical-align:middle;" id="totaltotal{{$ST->st_payment_for}}">
