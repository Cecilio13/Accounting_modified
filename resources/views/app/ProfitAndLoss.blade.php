                            ...
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    if(filtertemplate!="All"){
                                        document.getElementById('report_employee_title').innerHTML="PROFIT AND LOSS ("+convertDate(FROM)+" - "+convertDate(TO)+")";
                                    }else{
                                        document.getElementById('report_employee_title').innerHTML="PROFIT AND LOSS";
                                    }
                                    //window.location.replace("/Invoice_List?date_from="+FROM+"&date_to="+TO);
                                    $.ajax({
                                        type: 'POST',
                                        url: 'ProfitandlossByDate',                
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Profit And Loss";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Profit And Loss</td>
                    </tr>
                    <tr>
