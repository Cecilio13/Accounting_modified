...
<div class="row">
    <div class="col-md-12">
        <h4>Transaction List by Supplier Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Transaction List by Supplier";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Transaction List by Supplier</td>
                    </tr>
                    <tr>
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tbody>
                                    ...
                                    <td style="vertical-align:middle;">
                                        ...
                                        <span title='overdue' style='color:red;'>{{$et2->et_due_date!=""? date('m-d-Y',strtotime($et2->et_due_date)) : ""}}</span>

                                        @else
                                        {{$et2->et_due_date!=""? date('m-d-Y',strtotime($et2->et_due_date)) : ""}}
                                        @endif
                                        @endif
