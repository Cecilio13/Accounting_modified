            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="card" style="border:0px solid #ccc;">
                    ...
                    <div class="card-body">
                        ...
                        <script>
                            function changeyear(){
                                ...
                                var first = curr.getDate() - curr.getDay(); // First day is the day of the month - the day of the week
                                        ...
                                        FROM.value=year+"-"+(firstday.getMonth()+1)+"-"+first;
                                        TO.value=year+"-"+(lastday.getMonth()+1)+"-"+last;
                                        submitdates();
                            }
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    if(filtertemplate!="All"){
                                        document.getElementById('report_employee_title').innerHTML="QUARTERLY PROFIT AND LOSS SUMMARY ("+convertDate(FROM)+" - "+convertDate(TO)+")";
                                    }else{
                                        document.getElementById('report_employee_title').innerHTML="QUARTERLY PROFIT AND LOSS SUMMARY";
                                    }
                                    //window.location.replace("/Invoice_List?date_from="+FROM+"&date_to="+TO);
                                    $.ajax({
                                        type: 'POST',
                                        url: 'QuarterlyProfitandlossByDate',                
                        ...
                        <div id="dateYear" style="display:none;margin-top:10px;">
                            <select class="form-control" id="filterYear" onchange="changeyear()">
                            <?php
                                for($i=0; $i<10; $i++){
                                    $timesss = strtotime("-".$i." year", time());
                                    $datesss = date("Y", $timesss);
                                    ?>
                                    <option>{{$datesss}}</option>
                                    <?php
                                }
                            ?>
                            </select>
...
<div class="row">
    <div class="col-md-12">
        <h4>Quarterly Profit and Loss Summary Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
                        ...
                        <select class="form-control" id="filtertemplate" onchange="changedates(this)">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{date('Y-01-31')}}" class="form-control" oninput="submitdates()" onkeyup="submitdates()" id="Fromdate" >
                                    
                                </div>
                                <div class="form-group">
                                    <label for="Todate">To</label>
                                    <input type="date" value="{{date('Y-12-31')}}" class="form-control" oninput="submitdates()" onkeyup="submitdates()" id="Todate" >
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Quarterly Profit and Loss Summary";
            ...
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <td style="vertical-align:middle;text-align:right;">
                        <a href="#" class="btn-link btn-upper-report" title="Export to Excel" onclick="exporttoexcelprofitandlossquarterly()"><span class="fa fa-table"></a>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Quarterly Profit and Loss Summary</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <th  colspan="3"></th>
                                    ...
                                    <th>Jan-Mar {{$CurrentYear}}</th>
                                    <th>Apr-Jun {{$CurrentYear}}</th>
                                    <th>Jul-Sep {{$CurrentYear}}</th>
                                    <th>Oct-Dec {{$CurrentYear}}</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="8" style="vertical-align:middle;font-weight:bold;font-size:14px;">Income</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="{{count($output)+4}}" style="vertical-align:middle;font-weight:bold;font-size:14px;">{{$coa->coa_account_type}}</td>
                                    ...
                                    <tr>
                                        ...
                                        <?php $individualinvoice=0; ?>
                                        <?php $individualinvoice2=0; ?>
                                        <?php $individualinvoice3=0; ?>
                                        <?php $individualinvoice4=0; ?>
                                        ...
                                        <td style="vertical-align:middle;">{{number_format($individualinvoice,2)}}</td>
                                        <td style="vertical-align:middle;">{{number_format($individualinvoice2,2)}}</td>
                                        <td style="vertical-align:middle;">{{number_format($individualinvoice3,2)}}</td>
                                        <td style="vertical-align:middle;">{{number_format($individualinvoice4,2)}}</td>
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="{{count($output)+4}}" style="vertical-align:middle;text-align:right;border-top:1px dotted #ccc"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" style="vertical-align:middle;font-weight:bold;font-size:14px;">Less Cost of Sales</td>
                                    ...
                                    <tr>
                                        <td colspan="{{count($output)+4}}" style="vertical-align:middle;text-align:right;border-top:2px solid #ccc"></td>
                                    </tr>
                                    <!--expense-->
                                    <tr>
                                        <td colspan="8" style="vertical-align:middle;font-weight:bold;font-size:14px;">Less Operating Expenses</td>
                                    ...
                                    <tr style="background-color: #eaf0f7;border-top:2px solid #ccc;">
                                        <td colspan="3" style="border-top:2px solid solid #ccc;vertical-align:middle;font-weight:bold;font-size:14px;">Net Income</td>
                                        <?php $individualinvoice=0; ?>
                                        <?php $individualinvoice2=0; ?>
                                        <?php $individualinvoice3=0; ?>
                                        <?php $individualinvoice4=0; ?>
                                        ...
                                        <?php $individualinvoice12=0; ?>
                                        <?php $individualinvoice22=0; ?>
                                        <?php $individualinvoice32=0; ?>
                                        <?php $individualinvoice42=0; ?>
                                        @foreach ($COA as $Coa)
                                        @if ($Coa->coa_title=="Expenses" && $Coa->coa_account_type!="Cost of Sales")
                                        @foreach ($JournalEntry as $JE)
                                        @if(date('Y-m-d',strtotime($JE->created_at))>=date('Y-m-d',strtotime($CurrentYear."-01-01")) && date('Y-m-d',strtotime($JE->created_at))<=date('Y-m-d',strtotime($CurrentYear."-03-31")))
                                    ...
                                    <td style="vertical-align:middle;border-top:2px solid solid #ccc;">{{number_format($individualinvoice-$individualinvoice12,2)}}</td>
                                    <td style="vertical-align:middle;border-top:2px solid solid #ccc;">{{number_format($individualinvoice2-$individualinvoice22,2)}}</td>
                                    <td style="vertical-align:middle;border-top:2px solid solid #ccc;">{{number_format($individualinvoice3-$individualinvoice32,2)}}</td>
                                    <td style="vertical-align:middle;border-top:2px solid solid #ccc;">{{number_format($individualinvoice4-$individualinvoice42,2)}}</td>
                                        <td style="border-top:2px solid solid #ccc;vertical-align:middle;text-align:right;font-weight:bold;">{{number_format($GrossProfit-$TotalOperatingExpense,2)}}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="{{count($output)+4}}" style="vertical-align:middle;text-align:right;border-top:2px solid #ccc"></td>
                                    </tr>        
