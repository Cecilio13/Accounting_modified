...
<div class="row">
    <div class="col-md-12">
        <h4>Balance Sheet Detail Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Balance Sheet Detail";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Balance Sheet Detail</td>
                    </tr>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td colspan="7" style="vertical-align:middle;font-weight:bold;font-size:14px;">Assets</td>
                    </tr>
                    <tr>
                        <td colspan="7" style="vertical-align:middle;font-weight:bold;font-size:11px;">Current Assets</td>
                    </tr>
                    <?php
                    $IncomeTotal=0;
                    ?>
                    ...
                    @foreach ($coa_account_type as $coa)
                        @if ($coa->coa_account_type=="Bank")
                            <tr>
                                ...
                                <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:11px;">{{$coa->coa_account_type}}</td>
                            </tr>
                            @foreach ($COA as $Coa)
                                @if ($Coa->coa_account_type=="Bank")
                                    <tr>
                                        <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                        <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                        <td colspan="4" class="dottedborder" style="vertical-align:middle;font-size:11px;">{{$Coa->coa_name}}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                        <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                        <td  class="dottedborderinner" style="vertical-align:middle;font-size:11px;">{{date('m-d-Y',strtotime($JE->created_at))}}</td>
                                        <td  class="dottedborderinner" style="vertical-align:middle;font-size:11px;">{{$JE->je_transaction_type}}</td>
                                        <td  class="dottedborderinner" style="vertical-align:middle;font-size:11px;">{{$JE->je_transaction_type!="Journal Entry"? $JE->other_no : $JE->je_no}}</td>
                                        <td class="dottedborderinner" style="vertical-align:middle;font-size:11px;text-align:right;">
                                            
                                            {{number_format(-$JE->je_credit,2)}}
                            ...
                            <tr>
                                <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:11px;">Total {{$coa->coa_account_type}}</td>
                                <td style="vertical-align:middle;font-size:11px;text-align:right;font-weight:bold;">{{number_format($IncomeTotal,2)}}</td>
                            </tr>
                        @endif
                    @endforeach
                    <tr>
                        <td colspan="7" style="border-bottom:1px dotted #ccc"></td>
                    </tr>
                    <?php
                    $IncomeTotal=0;
                    ?>
                    ...
                    @foreach ($coa_account_type as $coa)
                        @if ($coa->coa_account_type=="Prepayments")
                            <tr>
                                <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:11px;">{{$coa->coa_account_type}}</td>
                            </tr>
                            @foreach ($COA as $Coa)
                                @if ($Coa->coa_account_type=="Prepayments")
                                    <tr>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:11px;">Total Current Assets</td>
                        <td style="vertical-align:middle;font-size:11px;text-align:right;font-weight:bold;">{{number_format($TotalIncomeTotal,2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="7" style="border-bottom:2px dotted #ccc"></td>
                    </tr>
                    <tr>
                        <td colspan="7" style="vertical-align:middle;font-weight:bold;font-size:11px;"></td>
                    </tr>
                    <?php
                    $IncomeTotal=0;
                    $TotalFixedAsset=0;
                    ?>
                            ...
                            <tr>
                                <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:11px;">Fixed Assets</td>
                            </tr>
                            @foreach ($COA as $Coa)
                                @if ($Coa->coa_account_type=="Land, Building and Improvements" || $Coa->coa_account_type=="Equipment and Improvements" || $Coa->coa_account_type=="Asset Contra Accounts")
                                    <tr>
                                        <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                        <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                        <td colspan="4" class="dottedborder" style="vertical-align:middle;font-size:11px;">{{$Coa->coa_name}}</td>
                            ...
                            <tr>
                                <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:11px;">Total Fixed Assets</td>
                                <td style="vertical-align:middle;font-size:11px;text-align:right;font-weight:bold;">{{number_format($IncomeTotal,2)}}</td>
                            </tr>
                    <?php
                    $IncomeTotal=0;
                    ...
                    <tr>
                        <td colspan="7" style="border-bottom:2px dotted #ccc"></td>
                            ...
                            <tr>
                                <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:11px;">Non-Current Assets</td>
                            </tr>
                            @foreach ($COA as $Coa)
                                @if ($Coa->coa_account_type=="Improvements" )
                                    <tr>
                                        <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                        <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                        <td colspan="4" class="dottedborder" style="vertical-align:middle;font-size:11px;">{{$Coa->coa_name}}</td>
                            ...
                            <tr>
                                <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:11px;">Total Non-Current Assets</td>
                                <td style="vertical-align:middle;font-size:11px;text-align:right;font-weight:bold;">{{number_format($IncomeTotal,2)}}</td>
                            </tr>
                    <tr>
                        <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:14px;">Total Assets</td>
                    ...
                    <tr>
                        <td colspan="7" style="border-bottom:3px dotted #ccc"></td>
                    </tr>
                    <tr>
                        <td colspan="7" style="vertical-align:middle;font-weight:bold;font-size:14px;">Liabilities</td>
                        
                    </tr>
                        <tr>
                            <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                            <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:11px;">Current Liabilities</td>
                        </tr>
                        <?php
                        $IncomeTotal=0;
                        $TotalLiabilities=0;
                        ?> 
                        @foreach ($COA as $Coa)
                            @if ($Coa->coa_account_type=="Payable Accounts" )
                                <tr>
                                    <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                    <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                    <td colspan="4" class="dottedborder" style="vertical-align:middle;font-size:11px;">{{$Coa->coa_name}}</td>
                        ...
                        <tr>
                            <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                            <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:11px;">Total Current Liabilities</td>
                            <td style="vertical-align:middle;font-size:11px;text-align:right;font-weight:bold;">{{number_format($IncomeTotal,2)}}</td>
                        </tr>
                        <tr>
                            <td colspan="7" style="border-bottom:2px dotted #ccc"></td>
                        ...
                        <tr>
                            <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                            <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:11px;">Other Current Liabilities</td>
                        </tr>
                        <?php
                        $IncomeTotal=0;
                        ?> 
                        @foreach ($COA as $Coa)
                            @if ($Coa->coa_account_type=="Other Payables" )
                                <tr>
                                    <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                    <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                    <td colspan="4" class="dottedborder" style="vertical-align:middle;font-size:11px;">{{$Coa->coa_name}}</td>
                        ...
                        <tr>
                            <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                            <td colspan="5" style="vertical-align:middle;font-weight:bold;font-size:11px;">Total Other Current Liabilities</td>
                            <td style="vertical-align:middle;font-size:11px;text-align:right;font-weight:bold;">{{number_format($IncomeTotal,2)}}</td>
                        </tr>
                        <tr>
                            <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:14px;">Total Liabilities</td>
                        ...
                        <tr style="background-color: #eaf0f7;border-top:2px solid #ccc;border-bottom:2px solid #ccc;">
                            <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:14px;">Net Assets</td>
                        ...
                        <tr>
                            <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:14px;">Equity</td>
                        </tr>
                        <tr>
                            <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                            <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                            <td class="dottedborder" colspan="4" style="vertical-align:middle;font-size:11px;">Earnings</td>
                            <td class="dottedborder" style="vertical-align:middle;font-size:11px;text-align:right;">
                                    <?php
                                    $CustomerTotal=0;
                                    ?>
                        ...
                        ?>
                        <tr style="background-color: #eaf0f7;border-top:2px solid #ccc;border-bottom:2px solid #ccc;">
                            <td colspan="6" style="vertical-align:middle;font-weight:bold;font-size:14px;">Total Equity</td>
