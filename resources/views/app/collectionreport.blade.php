...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Collection Report";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Collection Report</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                @if($emp->st_type=="Invoice" && ($diff->format("%R")=="-" || ($diff->format("%R")=="+" && $diff->format("%a")=="0")) && ($emp->st_status=="Open" || $emp->st_status=="Partially paid" ))
                                ...
                                <td style="vertical-align:middle;">
                                    @if($emp->st_due_date!="")
                                            ...
                                            <span title='overdue' style='color:red;'>{{$emp->st_due_date!=""? date('m-d-Y',strtotime($emp->st_due_date)) : ""}}</span>
                                ...
                                <td style="vertical-align:middle;">
                                        {{number_format($emp->st_balance,2)}}
                                <script>
                                    var total=0;
                                ...
                                <td style="vertical-align:middle;">{{$emp->st_bill_address}}</td>
                                <td style="vertical-align:middle;">{{$emp->st_term}}</td>
