...
<div class="container">
    ...
    @foreach ($chartofaccountbydetailtype as $detail)
        ...
        <?php
        $ReportHeader=$detail->coa_detail_type;
        ?>
        @endif
    @endforeach
<div class="row">
    <div class="col-md-12">
        <h4>{{$ReportHeader}} Ledger Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <a href="Ledger_for_COA_Desc" class="btn btn-link btn-sm" style="padding-left:0px;text-decoration: none;"><span class="oi oi-chevron-left"></span> Back to report list</a>
    </div>
</div>
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="{{$ReportHeader}} Ledger";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >{{$ReportHeader}} Ledger</td>
                    </tr>
                    <tr>
                        ...
                        opacity: 1;
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tbody>
                                    ...
                                    @if($detail->id==$je->je_account)
                                        ...
                                        <tr style="border-bottom:1px solid #ccc;">
                                                <td colspan="1" style="text-align:left;vertical-align:middle;">
                                                    <a style="cursor:pointer;" onclick="getModal('{{$je->other_no}}','{{$je->je_transaction_type}}','')">    
                                                    {{$je->other_no}}
                                                    </a>
                                                </td>
                                                ...
                                                <td colspan="1" style="text-align:left;vertical-align:middle;">
                                                    <a style="cursor:pointer;" onclick="getModal('{{$je->other_no}}','{{$je->je_transaction_type}}','')">    
                                                    {{$treandate!=""? date('m-d-Y',strtotime($treandate)) : ''}}
                                                    </a>
                                                ...
                                                <td colspan="1" style="vertical-align:middle;">
                                                    ...
                                                    <div class="tooltip-custom">View Note
                                                    <span class="tooltiptext">{{$je->cancellation_reason}}</span>
                                                    </div>
                                                    @endif
                                                </td>
                                        ...
                                        <tr style="border-bottom:1px solid #ccc;">
                                            ...
                                            <td colspan="1" style="text-align:left;vertical-align:middle;">
                                                ...
                                                {{$je->cancellation_date!=""? date('m-d-Y',strtotime($je->cancellation_date)) : '' }}
                                        ...
                                        @elseif($je->je_transaction_type=="Journal Entry")
                                        ...
                                        <tr style="border-bottom:1px solid #ccc;">
                                            ...
                                            <td colspan="1" style="text-align:left;vertical-align:middle">
                                                ...
                                                {{$je->created_at!=""? date('m-d-Y',strtotime($je->created_at)) : ''}}
                                   ...
                                   <td style="text-align:right;vertical-align:middle;font-weight:bold;">
                                    {{number_format($totaldescamount,2)}}
                                    </td>
                                   </tr>
                                </tbody>
                            </table>
