    ...
    <div class="col-md-10 ">
            <div class="col-md-12" style="background-color: white;padding-top:15px;padding-bottom:15px;padding-left:0px;padding-right:0px;">
                    ...
                    <div class="col-md-6 ">
                            ...
                            <label class="custom-control-label" for="customCheck6">Account Code</label>
                            ...
                            <label class="custom-control-label" for="customCheck1">Account Type</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="customCheck2">Account Title</label>
                            </div>
                    ...
                    <div class="col-md-6 ">
                            ...
                            <label class="custom-control-label" for="customCheck4">Balance</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                            <input type="checkbox" onclick="hideshowcolumntable(this)" name="columnnames[]"  class="custom-control-input" value="6" id="customCheck7">
                            <label class="custom-control-label" for="customCheck7">Create Date</label>
                            </div>
                    </div>
                </div>
            </div>  
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Account List";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Account List</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tbody>
                                    ...
                                    @if($coc->coa_active!="0")
                                    <tr>
                                    <td style="vertical-align:middle;">{{$coc->coa_code}}</td>
