                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'AccountsPayableAgeingSummaryByDate',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Accounts Payable Ageing Summary Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Accounts Payable Ageing Summary";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Accounts Payable Ageing Summary</td>
                    </tr>
                    <tr>
