                            ...
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    if(filtertemplate!="All"){
                                        document.getElementById('report_employee_title').innerHTML="PROFIT AND LOSS BY CUSTOMER ("+convertDate(FROM)+" - "+convertDate(TO)+")";
                                    }else{
                                        document.getElementById('report_employee_title').innerHTML="PROFIT AND LOSS BY CUSTOMER";
                                    }
                                    //window.location.replace("/Invoice_List?date_from="+FROM+"&date_to="+TO);
                                    $.ajax({
                                        type: 'POST',
                                        url: 'ProfitandlossByCustomerByDate',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Profit And Loss By Customer Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Profit And Loss By Customer";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Profit And Loss By Customer</td>
                    </tr>
                    <tr>
