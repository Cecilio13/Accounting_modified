                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'Customer_Balance_Summary_by_date',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Customer Balance Summary Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Customer Balance Summary";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Customer Balance Summary</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tr style="border-bottom:1px solid #ccc;">
                                    ...
                                    <td style="vertical-align:middle;text-align:right;" id="total_balancetd{{$emp->st_no}}">
                                        
                                        <script>
                                           var total=0;
                                           var id="total_balancetd{{$emp->st_no}}";
                                            <?php
                                            $tot=0;
                                            ?>
                                            @foreach($SalesTransaction as $emp)
                                            @if($emp->customer_id==$STC->st_customer_id)
                                            @if($emp->st_type=="Invoice" && ($emp->remark!="Cancelled") && ($emp->st_status=="Open" || $emp->st_status=="Partially paid"))
                                            <?php
                                            $tot+=$emp->st_balance;
                                            ?>
                                            total=parseFloat(total)+parseFloat('{{$emp->st_balance}}');
                                            //document.getElementById(id).innerHTML=(total).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                                            @elseif($emp->st_type=="Credit Note")
                                            <?php
                                            ...
                                            @endif
                                            @endforeach
                                            document.getElementById(id).innerHTML='{{number_format($tot,2)}}';
                                        </script>
                                    </td>
                                </tr>
