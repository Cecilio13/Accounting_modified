...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Cheque Detail";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Cheque Detail</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tbody>
                                    ...
                                    @foreach($expense_transactionssss as $et)
                                    <tr>
                                    <td style="vertical-align:middle;">{{$et->et_date!=""? date('m-d-Y',strtotime($et->et_date)) : ""}}</td>
                                    <td style="vertical-align:middle;">{{$et->et_type}}</td>
                                    <td style="vertical-align:middle;">{{$et->et_no}}</td>
                                    <td style="vertical-align:middle;">{{$et->et_memo}}</td>
                                    <td style="vertical-align:middle;text-align:right;" id="Total{{$et->et_no}}"></td>
                                    </tr>
                                    @foreach($et_account_details as $etd)
                                    @if($etd->et_ad_no==$et->et_no)
                                    <tr>
                                    ...
                                    <td style="vertical-align:middle;"></td>
                                    <td style="vertical-align:middle;"></td>
                                    <td style="vertical-align:middle;">{{$etd->et_ad_desc}}</td>
                                    <td style="vertical-align:middle;text-align:right;">
                                        {{number_format($etd->et_ad_total,2)}}
