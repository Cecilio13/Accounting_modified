...
<div class="row">
    <div class="col-md-12">
        <h4>Supplier Contact List Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-10 ">
            <div class="col-md-12" style="background-color: white;padding-top:15px;padding-bottom:15px;padding-left:0px;padding-right:0px;">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <label class="custom-control-label" for="customCheck6">Supplier</label>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <label class="custom-control-label" for="customCheck7">Account No.</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="customCheck9">Term</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="customCheck10">Note</label>
                        </div>     
                    </div>
                </div>
            </div>  
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Supplier Contact List";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Supplier Contact List</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <td style="vertical-align:middle;">{{$emp->company}}</td>
                                <td style="vertical-align:middle;">{{$emp->terms}}</td>
                                <td style="vertical-align:middle;">{{$emp->notes}}</td>
                                </tr>
                                @endif
                                @endforeach
                                </tbody>
