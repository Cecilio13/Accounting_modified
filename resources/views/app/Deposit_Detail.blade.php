            ...
            <div class="col-md-12" style="background-color: white;padding-top:15px;padding-bottom:15px;padding-left:0px;padding-right:0px;">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="col-md-6" style="padding-right:0px;">
                            ...
                            <label class="custom-control-label" for="customCheck7">Payment Method</label>
                            </div>
                            <div class="custom-control custom-checkbox">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Deposit Detail";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Deposit Detail</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <td style="vertical-align:middle;" >
                                        {{number_format($emp->st_amount_paid,2)}} 
                                </td>
