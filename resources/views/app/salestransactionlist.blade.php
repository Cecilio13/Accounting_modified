                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'sales_transaction_list_by_date',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Sales Transaction List Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Sales Transaction List";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Sales Transaction List</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                @foreach ($SalesTransaction as $ST)
                                    ...
                                    <tr>
                                        <td style="vertical-align:middle;">{{$ST->st_date!=""?date('m-d-Y',strtotime($ST->st_date)) : ''}}</td>
                                        <td style="vertical-align:middle;">{{$ST->st_type}}</td>
                                        <td style="vertical-align:middle;">{{$ST->st_no}}</td>
                                        <td style="vertical-align:middle;">{{$ST->display_name!=""? $ST->display_name : $ST->f_name." ".$ST->l_name}}</td>
                                        <td style="vertical-align:middle;">
                                            @if($ST->st_due_date!="")
                                                ...
                                                <span title='overdue' style='color:red;'>{{$ST->st_due_date!=""? date('m-d-Y',strtotime($ST->st_due_date)) : ""}}</span>

                                                @else
                                                {{$ST->st_due_date!=""? date('m-d-Y',strtotime($ST->st_due_date)) : ""}}
                                                @endif
                                            @endif
                                            
                                        </td>
                                        <td style="vertical-align:middle;">{{number_format($ST->st_balance,2)}}</td>
                                        <td style="vertical-align:middle;">
                                            ...
                                            @endif
                                            @endforeach
                                            {{number_format($estimate_total,2)}}
                                            ...
                                            @elseif($ST->st_type == "Refund Receipt")
                                            <?php
                                            ...
                                            @endif
                                            @endforeach
                                            {{number_format($refund_receipt_total,2)}}
                                            @elseif($ST->st_type == "Charge")
                                            <?php
                                            ...
                                            @endif
                                            @endforeach
                                            {{number_format($delayed_charge_total,2)}}
                                            ...
                                            @endif
                                            @endforeach
                                            {{number_format("-".$credit_note_total,2)}}
                                            @else
                                            {{number_format($ST->st_amount_paid,2)}}
                                            @endif
                                        </td>
                                        <td style="vertical-align:middle;">{{$ST->st_status}}</td>
                                    </tr>
                                    @endif
                                @endforeach
                                </tbody>
