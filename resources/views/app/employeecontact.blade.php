                ...
                <div class="card" style="border:0px solid #ccc;">
                    ...
                    <script>
                        $(document).ready(function(){
                            //tablemain
                            $('td:nth-child(1),th:nth-child(1)','#tablemain ').hide();
                            for(var i=6;i<11;i++){
                        ...
                        <input type="checkbox" onclick="hideshowcolumntable(this)" name="columnnames[]" class="custom-control-input" value="1" id="customCheck6">
                        <label class="custom-control-label" for="customCheck6">Employee ID</label>
                        ...
                        <label class="custom-control-label" for="customCheck10">Hire Date</label>
                        </div>
                    </div>
                    </div>
                </div>
...
<div class="row">
    <div class="col-md-12">
        <h4>Employee Contact List Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Employee Contact List";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <td style="vertical-align:middle;text-align:left;">
                        ...
                        <form style="padding:1px 10px;">
                            ...
                            <select id="Sortbyselect" class="form-control" onchange="ss()">
                                ...
                                <option value="6">Civil Status</option>
                                <option value="7">Date of Birth</option>
                                <option value="8">Position</option>
                                <option value="9">Hire Date</option>                                
                            </select>
                            <script>
                                function ss(){
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Employee Contact List</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <td style="vertical-align:middle;">{{$emp->fname." ".$emp->lname}}</td>
                                    <td style="vertical-align:middle;">
                                        @foreach($Employee_contact as $emp_cont)
                                            @if($emp_cont->emp_id==$emp->employee_id)
                                                {{$emp_cont->phone_number}}<br>
                                            @endif
                                        @endforeach
                                    </td>
                                    <td style="vertical-align:middle;">
                                        @foreach($Employee_Email as $emp_email)
                                            @if($emp_email->emp_id==$emp->employee_id)
                                                {{$emp_email->email}}<br>
                                            @endif
                                        @endforeach
                                    </td>
                                <td style="vertical-align:middle;">{{$emp->address}}</td>
                                <td style="vertical-align:middle;">{{$emp->gender}}</td>
                                <td style="vertical-align:middle;">{{$emp->civil_status}}</td>
                                <td style="vertical-align:middle;">{{$emp->date_of_birth!=""? date('m-d-Y',strtotime($emp->date_of_birth)) : ""}}</td>
                                <td style="vertical-align:middle;">{{$emp->position}}</td>
                                
                                <td style="vertical-align:middle;">{{$emp->start_date!=""? date('m-d-Y',strtotime($emp->start_date)) : ""}}</td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
