...
<div class="row">
    <div class="col-md-12">
        <h4>Sub Ledger Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <a href="General_Ledger" class="btn btn-link btn-sm" style="padding-left:0px;text-decoration: none;"><span class="oi oi-chevron-left"></span> Back to report list</a>
    </div>
</div>
    ...
    <div class="col-md-12 ">
            <div class="col-md-12" style="background-color: white;padding-top:15px;padding-bottom:15px;padding-left:0px;padding-right:0px;">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control selectpicker" data-live-search="true" onchange="redirectwithID(this.value)">
                            @if($customer_id!="")
                            <option value="{{$customer_id}}">
                                @foreach ($customers as $cscs)
                                    @if ($cscs->customer_id==$customer_id)
                        ...
                        <script>
                            ...
                            function redirectwithID(id){
                                if(id!=""){
                                    window.location.href = "sub_ledger?chart_of_accounts={{$cao_id}}&id="+id;
                                }else{
                                    window.location.href = "sub_ledger?chart_of_accounts={{$cao_id}}"; 
                                }
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Sub Ledger";
            ...
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <td style="vertical-align:middle;text-align:right;">
                        <a href="#" class="btn-link btn-sm" title="Export to Excel" onclick="exportTableToExcel('tablemain', 'members-data')"><span class="fa fa-table"></a>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Sub Ledger</td>
                    </tr>
                    <tr>
                        ...
                        <a id="exportsasd">
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                <thead>
                                    ...
                                    @if ($customer_id!="")
                                        <tr style="border-bottom:1px solid ccc;">
                                            <th colspan="5" style="vertical-align:middle;font-weight:bold;text-align:center;">
                                ...
                                <tbody>
                                        ...
                                        @if ($customer_id!="")
                                            @if ($JE->je_account==$coa->id && $JE->remark!='Cancelled' && $JE->je_name==$customer_name)
                                       ...
                                       <tr style="border-bottom:1px solid ccc;">
                                            <td style="vertical-align:middle;font-weight:bold;" colspan="5">{{$coa->coa_name." (".$coa->coa_code.")"}}</td>
