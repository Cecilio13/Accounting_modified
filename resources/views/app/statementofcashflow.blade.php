                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'StatementofCashFlowByDate',                
                                        data: {filtertemplate:filtertemplate,FROM:FROM,TO:TO,_token: '{{csrf_token()}}'},
...
<div class="row">
    <div class="col-md-12">
        <h4>Statement of Cash Flows Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Statement of Cash Flows";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Statement of Cash Flows</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="vertical-align:middle;font-weight:bold;">Cash flows from operating activities</td>
                                        <td style="vertical-align:middle;"></td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:20px;font-weight:bold">Profit for the Period</td>
                                        <?php $incometotal=0; ?>
                                        <?php $invoicetotal=0; ?>
                                        <?php $creditnotetotal=0; ?>
                                        @foreach($SalesTransaction as $ST)
                                        @if($ST->st_type=="Invoice")
                                        @foreach($st_invoice as $st)
                                        @if($ST->st_no==$st->st_i_no)
                                        <?php $incometotal+=$st->st_i_total; ?>
                                        @endif
                                        @endforeach
                                        @elseif($ST->st_type=="Credit Note")
                                        <?php $incometotal+=$ST->st_amount_paid; ?>
                                        @endif
                                        @endforeach
                                        ...
                                        <?php $expensestotal+=$acc->et_ad_total; ?>
                                        @endif
                                        @endforeach
                                        @endforeach

                                        <?php $AccountRecievable=0; ?>
                                        @foreach($SalesTransaction as $csasasd)
                                            @if($csasasd->st_type=="Invoice")
                                                <?php $AccountRecievable=$AccountRecievable+$csasasd->st_balance; ?>
                                                
                                            @endif
                                            @if($csasasd->st_type=="Credit Note")
                                            <?php $AccountRecievable=$AccountRecievable+$csasasd->st_amount_paid;?>
                                            
                                            @endif
                                            @if($csasasd->st_type=="Payment")
                                                <?php $AccountRecievable=$AccountRecievable-$csasasd->st_amount_paid; ?>
                                    ...
                                    @foreach ($expense_transactions as $et)
                                            @foreach ($et_account_details as $ead)
                                                @if ($ead->et_ad_no==$et->et_no)
                                                    ...
                                                    <?php $Inventory+=$ead->et_ad_total; ?>
                                                    @elseif($ead->et_ad_product=="Allowance for bad debt")
                                                    <?php $Allowanceforbaddebt+=$ead->et_ad_total; ?>
                                                    @elseif($ead->et_ad_product=="Available for sale assets (short-term)")
                                                    <?php $Availableforsaleassets+=$ead->et_ad_total; ?>
                                                    @elseif($ead->et_ad_product=="Inventory Asset")
                                                    <?php $InventoryAsset+=$ead->et_ad_total; ?>
                                                    @elseif($ead->et_ad_product=="Prepaid expenses")
                                                    <?php $Prepaidexpenses+=$ead->et_ad_total; ?>
                                                    @elseif($ead->et_ad_product=="Uncategorised Asset")
                                                    <?php $UncategorisedAsset+=$ead->et_ad_total; ?>
                                                    @elseif($ead->et_ad_product=="Property, plant and equipment")
                                                    <?php $PPE+=$ead->et_ad_total; ?>
                                                    @elseif($ead->et_ad_product=="Assets held for sale")
                                                    <?php $AHOS+=$ead->et_ad_total; ?>
                                                    @endif
                                                @endif
                                            @endforeach
                                        @endforeach
                                        ...
                                        ?>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold">Php {{number_format($incometotal-$expensestotal,2)}}</td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:20px;font-weight:bold">Adjustments for non-cash income and expenses:</td>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold">Php -{{number_format($totalnoncash,2)}}</td>
                                    </tr>
                                    @if($AccountRecievable!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Account Receivable (A/R)</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($AccountRecievable,2)}}</td>
                                    </tr>
                                    @endif
                                    
                                    @if($Inventory!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Inventory</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($Inventory,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($Allowanceforbaddebt!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Allowance for bad debt</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($Allowanceforbaddebt,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($Availableforsaleassets!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Available for sale assets (short-term)</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($Availableforsaleassets,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($InventoryAsset!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Inventory Asset</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($InventoryAsset,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($Prepaidexpenses!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Prepaid expenses</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($Prepaidexpenses,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($UncategorisedAsset!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Uncategorised Asset</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($UncategorisedAsset,2)}}</td>
                                    </tr>
                                    @endif
                                    <tr style="border-top:2px solid #ccc;">
                                        <td style="vertical-align:middle;padding-left:20px;font-weight:bold;">Net cash from operating activities</td>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold;">Php {{number_format(($incometotal-$expensestotal)-$totalnoncash,2)}}</td>
                                    </tr>
                                    @if($totalinvest!=0)
                                    <tr>
                                        <td style="vertical-align:middle;font-weight:bold;">Cash flows from investing activities</td>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold;"></td>
                                    </tr>
                                    @if($PPE!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Property, plant and equipment</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($PPE,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($AHOS!=0)
                                    <tr>
                                        <td style="vertical-align:middle;padding-left:30px;">Assets held for sale</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($AHOS,2)}}</td>
                                    </tr>
                                    @endif
                                    <tr style="border-top:2px solid #ccc;">
                                        <td style="vertical-align:middle;padding-left:20px;font-weight:bold;">Net cash from investing activities</td>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold;">{{$totalinvest!=0? " Php -".number_format($totalinvest,2) : 'Php 0.00'}}</td>
                                    </tr>
                                    @endif
                                    <tr style="border-top:2px solid #ccc;">
                                        <td style="vertical-align:middle;padding-left:20px;font-weight:bold;">NET INCREASE (DECREASE) IN CASH AND CASH EQUIVALENTS</td>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold;">{{number_format((($incometotal-$expensestotal)-$totalnoncash)-$totalinvest,2)}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
