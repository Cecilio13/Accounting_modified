                                    ...
                                    function submitdates(){
                                        ...
                                        if((FROM=="" || TO=="") && filtertemplate!="All"){
                                            ...
                                            if(filtertemplate!="All"){
                                                document.getElementById('report_employee_title').innerHTML="MOVEMENT IN EQUITY ("+convertDate(FROM)+" - "+convertDate(TO)+")";
                                            }else{
                                                document.getElementById('report_employee_title').innerHTML="MOVEMENT IN EQUITY";
                                            }
...
<div class="row">
    <div class="col-md-12">
        <h4>Movement in Equity Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Movement in Equity";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Movement in Equity</td>
                    </tr>
                    <tr>
                ...
                <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="dottedborder" style="vertical-align:middle;font-size:11px;">Opening Balance</td>
                            ...
                            <tr>
                                <td width="10px;" style="vertical-align:middle;font-size:11px;"></td>
                                <td colspan="2" class="dottedborder" style="vertical-align:middle;font-size:11px;">Earnings</td>
                                <td class="dottedborder" style="vertical-align:middle;font-size:11px;text-align:right;">
                                        <?php
                                        $CustomerTotal=0;
                                        ?>
                            ...
                            <tr style="background-color: #eaf0f7;border-top:2px solid #ccc;border-bottom:2px solid #ccc;">
                                ...
                                <td  style="vertical-align:middle;font-weight:bold;font-size:11px;text-align:right;">{{number_format(($CustomerTotal-$CustomerTotal2),2)}}</td>
