...
<div class="row">
    <div class="col-md-12">
        <h4>Summary of Chart of Accounts Description Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Summary of Chart of Accounts Description";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >SUMMARY OF CHART OF ACCOUNTS DESCRIPTION REPORT</td>
                    </tr>
                    <tr>
