                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control selectpicker" data-live-search="true" onchange="redirectwithID()" id="Customer_Supplier_Selection">
                            ...
                            <option value="{{$customer_id}}">
                                @foreach ($customers as $cscs)
                                    @if ($cscs->customer_id==$customer_id && $cscs->account_type=="Customer")
                        ...
                        <script>
                            ...
                            function redirectwithID(){
                                ...
                                if(account!=""){
                                    if(id!=""){
                                    window.location.href = "sub_ledger_by_customer?chart_of_accounts="+account+"&id="+id;
                                    }else{
                                        window.location.href = "sub_ledger_by_customer?chart_of_accounts="+account+""; 
                                    }
                                }
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Customer Ledger";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Customer Ledger</td>
                    </tr>
                    <tr>
                        ...
                        <a id="exportsasd">
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;width:100%;">
                                <thead>
                                    <?php
                                        $customer_name="";
                                    ?>
