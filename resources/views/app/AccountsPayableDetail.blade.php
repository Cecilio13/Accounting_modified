...
<div class="row">
    <div class="col-md-12">
        <h4>Accounts Payable Detail Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Accounts Payable Detail";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Accounts Payable Detail</td>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="vertical-align:middle;">{{date('m-d-Y', strtotime($et->et_date))}}</td>
                    ...
                    @endforeach
                <tr>
                    <td style="vertical-align:middle;font-weight:bold" colspan="5">Total</td>
                    <td style="vertical-align:middle;font-weight:bold;text-align:right;">Php {{number_format($Total,2)}}</td>
                </tr>        
                </tbody>
                </table>
                <script>
