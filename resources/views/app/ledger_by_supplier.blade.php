                        ...
                        <select class="form-control selectpicker" data-live-search="true" onchange="redirectwithID()" id="Customer_Supplier_Selection">
                            ...
                            <option value="{{$customer_id}}">
                                @foreach ($customers as $cscs)
                                    @if ($cscs->customer_id==$customer_id && $cscs->account_type=="Supplier")
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Supplier Ledger";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Supplier Ledger</td>
                    </tr>
                    <tr>
