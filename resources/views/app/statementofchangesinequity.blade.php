                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'StatementofchangeinequityByDate',                
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                @foreach ($expense_transactions as $et)
                                    ...
                                    <?php $Dividenddisbursed+=$ead->et_ad_total; ?>
                                    @elseif($ead->et_ad_product=="Equity in earnings of subsidiaries")
                                    <?php $Equityinearningsofsubsidiaries+=$ead->et_ad_total; ?>
                                    @elseif($ead->et_ad_product=="Other comprehensive income")
                                    <?php $Othercomprehensiveincome+=$ead->et_ad_total; ?>
                                    @elseif($ead->et_ad_product=="Retained Earnings")
                                    <?php $RetainedEarnings+=$ead->et_ad_total; ?>
                                    @elseif($ead->et_ad_product=="Share capital")
                                    <?php $Sharecapital+=$ead->et_ad_total; ?>
                                    @endif
                                    @endif
                                    @endforeach
                                @endforeach
                                    ...
                                    <tr>
                                        <td style="vertical-align:middle;">Dividend disbursed</td>
                                        <td style="vertical-align:middle;text-align:right;">-{{number_format($Dividenddisbursed,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($Equityinearningsofsubsidiaries!=0)
                                    <tr>
                                        <td style="vertical-align:middle;">Equity in earnings of subsidiaries</td>
                                        <td style="vertical-align:middle;text-align:right;">-{{number_format($Equityinearningsofsubsidiaries,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($Othercomprehensiveincome!=0)
                                    <tr>
                                        <td style="vertical-align:middle;">Other comprehensive income</td>
                                        <td style="vertical-align:middle;text-align:right;">-{{number_format($Othercomprehensiveincome,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($RetainedEarnings!=0)
                                    <tr>
                                        <td style="vertical-align:middle;">Retained Earnings</td>
                                        <td style="vertical-align:middle;text-align:right;">-{{number_format($RetainedEarnings,2)}}</td>
                                    </tr>
                                    @endif
                                    @if($Sharecapital!=0)
                                    <tr>
                                        <td style="vertical-align:middle;">Share capital</td>
                                        <td style="vertical-align:middle;text-align:right;">-{{number_format($Sharecapital,2)}}</td>
                                    </tr>
                                    @endif
                                    <tr>
                                        <td style="vertical-align:middle;font-weight:bold;">Total Equity</td>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold;">-{{number_format($totalequity,2)}}</td>
                                    </tr>
                                    @endif
                                </tbody>
                            </table>
