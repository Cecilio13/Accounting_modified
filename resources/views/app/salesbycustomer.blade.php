                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'salesbyCustomer_Summary_by_date',                
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Sales By Customer";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Sales By Customer</td>
                    </tr>
                    <tr>
                                    ...
                                    <td style="vertical-align:middle;text-align:right;" id="total_balancetd{{$emp->st_no}}">
                                        ...
                                        <script>
                                           ...
                                           <?php
                                            ...
                                            <?php
                                            $totalpoo+=$emp->st_balance;
                                            ?>
                                            total=total+'{{$emp->st_balance}}';
                                            ...
                                            $totalpoo-=$emp->st_balance;
                                            ?>
                                            total=total+'{{$emp->st_amount_paid}}';
