                            ...
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    if(filtertemplate!="All"){
                                        document.getElementById('report_employee_title').innerHTML="PROFIT AND LOSS BY MONTH ("+convertDate(FROM)+" - "+convertDate(TO)+")";
                                    }else{
                                        document.getElementById('report_employee_title').innerHTML="PROFIT AND LOSS BY MONTH";  
                                    }
                                    //window.location.replace("/Invoice_List?date_from="+FROM+"&date_to="+TO);
                                    $.ajax({
                                        type: 'POST',
                                        url: 'ProfitandlossByMonthByDate',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Profit and Loss By Month Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Profit and Loss By Month";
            ...
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <td style="vertical-align:middle;text-align:right;">
                        <a href="#" class="btn-link btn-upper-report" title="Export to Excel" onclick="exporttoexcelprofitandlossbymonth()"><span class="fa fa-table"></a>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Profit and Loss By Month</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                        <td colspan="{{count($output)+4}}" style="vertical-align:middle;font-weight:bold;font-size:14px;">Income</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="{{count($output)+3}}" style="vertical-align:middle;font-weight:bold;font-size:14px;">{{$coa->coa_account_type}}</td>
                                    ...
                                    <tr>
                                        <td colspan="{{count($output)+4}}" style="vertical-align:middle;font-weight:bold;font-size:14px;">Less Cost of Sales</td>
                                    ...
                                    <!--expense-->
                                    <tr>
                                        <td colspan="{{count($output)+4}}" style="vertical-align:middle;font-weight:bold;font-size:14px;">Less Operating Expenses</td>
                                    ...
                                    <tr style="background-color: #eaf0f7;border-top:2px solid #ccc;">
                                        ...
                                        <td style="vertical-align:middle;text-align:right;border-top:2px solid solid #ccc;">
                                                ...
                                                @endforeach
                                                {{number_format($coa_month-$coa_month2,2)}}
                                        </td>
                                        @endforeach
