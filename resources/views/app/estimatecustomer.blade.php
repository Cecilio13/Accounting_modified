                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'estimatebycustomer_by_date',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Estimates by  Customer Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
                    ...
                    <div class="col-md-6 ">
                       ...
                       <div class="col-md-6" style="padding-left:0px;">
                           <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="customCheck1">Estimate Status</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                        ...
                        <div class="col-md-6" style="padding-right:0px;">
                           <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="customCheck5">Email</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="customCheck11">Transaction type</label>
                            </div> 
                        </div>     
                    </div>
                    <div class="col-md-6 ">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Estimates by  Customer";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <td style="vertical-align:middle;text-align:left;">
                        ...
                        <form style="padding:1px 10px;">
                            ...
                            <select id="Sortbyselect" class="form-control" onchange="ss()">
                                ...
                                <option value="1">Estimate Status</option>
                                ...
                                <option value="10">Transaction type</option> 
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Estimates by  Customer</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <td style="vertical-align:middle;">
                                    {{$emp->st_date!=""? date('m-d-Y',strtotime($emp->st_date)) : ""}}
                                </td>
                                <td style="vertical-align:middle;">
                                    {{$emp->st_status}}
                                </td>
                                ...
                                <td style="vertical-align:middle;">
                                    {{$emp->st_due_date!=""? date('m-d-Y',strtotime($emp->st_due_date)) : ""}}
                                </td>
                                
                                <td style="vertical-align:middle;" id="invoicetotaltd{{$emp->st_no}}">
                                ...
                                <script>
                                    ...
                                    @endif
                                    @endforeach
                                    document.getElementById('invoicetotaltd{{$emp->st_no}}').innerHTML=(total).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                                </script>
                                </td>
                                <td style="vertical-align:middle;">{{$emp->st_bill_address}}</td>
                                <td style="vertical-align:middle;">{{$emp->st_bill_address}}</td>
                                <td style="vertical-align:middle;">{{$emp->st_type}}</td>
