...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Audit Log";
    ...
    <div class="col-md-12" >
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                <table class="report-main table table-sm"  style="width:80%;">
                <tbody>
                    ...
                    <td style="vertical-align:middle;text-align:left;">
                        ...
                        <a href="#!" class="btn-link btn-upper-report" id="showhidebtn" style="display:none;" onclick="showhode()">Add note</a>
                        <script>
                            var noteshow="0";
                            function showhode(){
                                if(noteshow==0){
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Audit Log</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                    <td style="vertical-align:middle;">{{$Log->created_at!=""? date('m-d-Y',strtotime($Log->created_at)) : ""}}</td>
                                    <td style="vertical-align:middle;">{{$Log->log_user_id}}</td>
                                    <td style="vertical-align:middle;">{{$Log->log_event}}</td>
                                    <td style="vertical-align:middle;">{{$Log->log_name}}</td>
                                    <td style="vertical-align:middle;">{{$Log->log_transaction_date!=""? date('m-d-Y',strtotime($Log->log_transaction_date)) : ""}}</td>
                                    <td style="vertical-align:middle;">{{$Log->log_amount!="" && $Log->log_amount!="-" ? number_format($Log->log_amount,2) : ''}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
