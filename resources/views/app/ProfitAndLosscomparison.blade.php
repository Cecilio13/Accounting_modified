                            ...
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    if(filtertemplate!="All"){
                                        document.getElementById('report_employee_title').innerHTML="PROFIT AND LOSS COMPARISON ("+convertDate(FROM)+" - "+convertDate(TO)+")";
                                    }else{
                                        document.getElementById('report_employee_title').innerHTML="PROFIT AND LOSS COMPARISON";
                                    }
                                    //window.location.replace("/Invoice_List?date_from="+FROM+"&date_to="+TO);
                                    $.ajax({
                                        type: 'POST',
                                        url: 'ProfitandlossComparisonByDate',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Profit And Loss Comparison Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Profit And Loss Comparison";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Profit And Loss Comparison</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:right;">Total(PY)</th>
                                </tr>
                                </thead>
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td class="noborderpls" style="vertical-align:middle;width:10px;"></td>                         <td colspan="4"  style="vertical-align:middle;font-weight:bold;font-size:14px;;">{{$coa->coa_account_type}}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($coa_name_total,2)}}</td>
                                    </tr>  
                                    @endif
                                    @endforeach
                                    <tr>
                                        <td class="noborderpls" style="vertical-align:middle;width:10px;"></td>                                         <td colspan="2" style="vertical-align:middle;font-weight:bold;font-size:11px;">Total Cost of Sales</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($IncomeTotal,2)}}</td>
                                        <td style="vertical-align:middle;text-align:right;">{{number_format($IncomeTotal,2)}}</td>
                                    </tr>
                                    @endif
                                    ...
                                    @if ($Coa->coa_account_type==$coa->coa_account_type)
                                    <tr>
                                        <td class="noborderpls" style="vertical-align:middle;width:10px;"></td>      <td class="noborderpls" style="vertical-align:middle;width:10px;"></td>      <td style="vertical-align:middle;font-size:11px;">{{$Coa->coa_name}}</td>
                                        <td style="vertical-align:middle;text-align:right;">
                                        <?php
                                        $coa_name_total=0;
                                        ?>
                                    ...
                                    @endforeach
                                    <tr>
                                    <td class="noborderpls" style="vertical-align:middle;width:10px;"></td>                          <td colspan="2" style="vertical-align:middle;font-weight:bold;font-size:11px;">Total {{$coa->coa_account_type}}</td>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold;">{{number_format($IncomeTotal,2)}}</td>
                                        <td style="vertical-align:middle;text-align:right;font-weight:bold;">{{number_format($IncomeTotal,2)}}</td>
                                    </tr>
                                    @endif
