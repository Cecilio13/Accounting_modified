                        ...
                        <script>
                            function submitdates(){
                                ...
                                if((FROM=="" || TO=="") && filtertemplate!="All"){
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'expense_transaction_list_by_date',                
...
<div class="row">
    <div class="col-md-12">
        <h4>Expenses Transaction List Report</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Expenses Transaction List";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Expenses Transaction List</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <a style="cursor:pointer;" onclick="getModal('{{$et->et_no}}','{{$et->et_type}}','')">    
                                    {{date('m-d-Y',strtotime($et->et_date))}}
                                </a>
                                </td>
                                ...
                                <td style="vertical-align:middle;" >
                                    <a style="cursor:pointer;" onclick="getModal('{{$et->et_no}}','{{$et->et_type}}','')">
                                    PHP {{number_format($et->et_ad_total,2)}}
                                    </a>
                                </td>
