            ...
            <div class="col-md-12" style="background-color: white;padding-top:15px;padding-bottom:15px;padding-left:0px;padding-right:0px;">
                    ...
                    <div class="col-md-6 ">
                       <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="customCheck6">Product ID</label>
                        ...
                        <label class="custom-control-label" for="customCheck1">Product/Services</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="customCheck3">Price</label>
                        </div>
...
<script>
    function SaveCustomReport(){
        ...
        var reportsettings = {};
            ...
            reportsettings['ReportType']="Product/Services List";
        ...
        <div class="reportbody">
            <div id="printablereport_employee_contact_list">
                ...
                <tbody>
                    ...
                    <td style="vertical-align:middle;text-align:left;">
                        ...
                        <form style="padding:1px 10px;">
                            ...
                            <select id="Sortbyselect" class="form-control" onchange="ss()">
                                ...
                                <option value="6">Reorder Point</option>
                    ...
                    <tr>
                        <td colspan="2" id="report_employee_title" style="vertical-align:middle;text-align:center;font-size:14px;font-weight:bold;text-transform: uppercase;" contenteditable="true" >Product/Services List</td>
                    </tr>
                    <tr>
                        ...
                        while (switching) {
                            ...
                            <table id="tablemain" class="table table-sm" style="text-align:left;font-size:12px;">
                                ...
                                <td style="vertical-align:middle;">{{$emp->product_id}}</td>
                                <td style="vertical-align:middle;">{{$emp->product_name}}</td>
                                    <td style="vertical-align:middle;">
                                            {{$emp->product_sales_description}}
                                    </td>
                                    <td style="vertical-align:middle;">
                                            {{number_format($emp->product_sales_price,2)}}
                                    </td>
                                <td style="vertical-align:middle;">{{$emp->product_sku}}</td>
                                <td style="vertical-align:middle;">{{number_format($emp->product_qty)}}</td>
                                <td style="vertical-align:middle;">{{$emp->product_reorder_point}}</td>
